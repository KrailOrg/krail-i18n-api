...
public interface PatternUtility {
     ...
     *
     * @param source          the {@link PatternDao} to uses as a source
     * @param target          the PatternDao to send the output to
     * @param bundles         the I18NKey classes to export (each key class is equivalent to a bundle)
     * @param locales         the Locales to export
     * @param autoStub        if true, and a value is not found, a stub value is exported.  The value is determined by stubWithKeyName and stubValue
